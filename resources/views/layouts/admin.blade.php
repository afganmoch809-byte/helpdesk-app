...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard') - Helpdesk</title>
            ...
            <div id="kt_app_header" class="app-header d-flex flex-column flex-stack">
                <div class="d-flex flex-stack flex-grow-1">
                    <div class="app-header-logo d-flex align-items-center ps-lg-12">
                        ...
                        <a href="{{ url('/') }}">
                            <h2 class="text-dark fw-bold">Helpdesk Admin</h2>
                        </a>
                    </div>
                                ...
                                <div class="menu-item px-3">
                                    <div class="menu-content d-flex align-items-center px-3">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">{{ Auth::user()->email ?? 'admin@example.com' }}</a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="kt_app_footer" class="app-footer">
                        <div class="app-container container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3">
                            <div class="text-dark order-2 order-md-1">
                                ...
                                <a href="#" class="text-gray-800 text-hover-primary">Helpdesk Admin</a>
                            </div>
                        </div>
                    </div>
                </div>
